    ...
    public void updateProject(Project updatedProject) {
        for (Project existingProject : projects) {
            if (existingProject.getId().equals(updatedProject.getId())) {
                ...
                existingProject.setVendorName(updatedProject.getVendorName());
                // Optionally, update other fields as needed

                return; // Exit the loop once the project is updated
            }
        }
        throw new IllegalArgumentException("Invalid project Id: " + updatedProject.getId());
    }
}
