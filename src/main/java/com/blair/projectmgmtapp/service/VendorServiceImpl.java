...
public class VendorServiceImpl implements VendorService {
    ...
    @Override
    public List<Vendor> findByZipCodeAndCategory(String zipCode, String category) {
        return vendorRepository.findByZipCodeAndCategoryOrderByRatingDesc(zipCode, category);
    }
